...
联动的效果可以看这两个例子：[例子A](http://localhost/echarts-website/examples/zh/view.html?c=candlestick-brush&edit=1&reset=1)，[例子B](http://localhost/echarts-website/examples/zh/view.html?c=scatter-nutrients-matrix&edit=1&reset=1)。
