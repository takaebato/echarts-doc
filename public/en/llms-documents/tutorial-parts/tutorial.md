...
*   Download official source release from [Apache ECharts website](http://localhost/echarts-website/en/download.html). Then [build](https://github.com/apache/echarts#build) from the source release.
...
For more examples, go to the [ECharts Gallery](http://localhost/echarts-website/examples/en/editor.html?c=doc-example/getting-started)
...
Setting a theme is the simplest way to change the color style. For example, in [Examples page](http://localhost/echarts-website/examples/en/index.html), "Theme" can be selected, and view the result directly.
...
Data in [Get started](#getting-started) is directly filled in `setOption` after initialization, but in some cases, data may be filled after asynchronous loading. Data updating asynchronously in Apache EChartsTM is very easy. After initialization, you can pass in data and configuration item through `setOption` after data obtained through jQuery and other tools at any time.
...
A: The [label.formatter](option.html#series.label.formatter) supports refer value in a certain dimension. For example:
...
For example, in the built-in boxplot transform, besides boxplot data produced, the outlier data are also produced, which can be used in a scatter series. See the [example](http://localhost/echarts-website/examples/en/editor.html?c=boxplot-light-velocity&edit=1&reset=1).
...
*   [Bar histogram](http://localhost/echarts-website/examples/en/editor.html?c=bar-histogram&edit=1&reset=1)
*   [Scatter clustering](http://localhost/echarts-website/examples/en/editor.html?c=scatter-clustering&edit=1&reset=1)
*   [Scatter linear regression](http://localhost/echarts-website/examples/en/editor.html?c=scatter-linear-regression&edit=1&reset=1)
*   [Scatter exponential regression](http://localhost/echarts-website/examples/en/editor.html?c=scatter-exponential-regression&edit=1&reset=1)
*   [Scatter logarithmic regression](http://localhost/echarts-website/examples/en/editor.html?c=scatter-logarithmic-regression&edit=1&reset=1)
*   [Scatter polynomial regression](http://localhost/echarts-website/examples/en/editor.html?c=scatter-polynomial-regression&edit=1&reset=1)
...
This is another [media query example](http://localhost/echarts-website/examples/en/editor.html?c=doc-example/bar-media-timeline&edit=1&reset=1).
...
Besides, ECharts provides [visualMap component](option.html#visualMap) for general visual mapping. Visual elements allowed in `visualMap` component are:  
`symbol`, `symbolSize`  
...
**[More samples of custom series](http://localhost/echarts-website/examples/en/index.html#chart-type-custom)**
...
[SVG PathData](http://www.w3.org/TR/SVG/paths.html#PathData) is supported, which enables to use shapes that are created in vector tool. See [path](option.html#series-custom.renderItem.return_path), and examples: [icons](http://localhost/echarts-website/examples/en/editor.html?c=custom-calendar-icon), [shapes](http://localhost/echarts-website/examples/en/editor.html?c=custom-gantt-flight).

  

**[More examples about custom series](http://localhost/echarts-website/examples/en/index.html#chart-type-custom)**
...
More examples: [Map Labels](http://localhost/echarts-website/examples/en/editor.html?c=map-labels&edit=1&reset=1), [Pie Labels](http://localhost/echarts-website/examples/en/editor.html?c=pie-nest&edit=1&reset=1), [Gauge](http://localhost/echarts-website/examples/en/editor.html?c=gauge-car&edit=1&reset=1).
...
Simple table can be implemented by specify the same width to text fragments that are in the same column of different lines. See the [example](http://localhost/echarts-website/examples/en/view.html?c=pie-rich-text&edit=1&reset=1) at the mentioned above.
...
*   When [building ECharts online](http://localhost/echarts-website/en/builder.html), the checkbox "SVG Renderer" should be checked.
...
[Beef Cuts](http://localhost/echarts-website/examples/en/editor.html?c=geo-beef-cuts) | [Organ Visualization](http://localhost/echarts-website/examples/en/editor.html?c=geo-organ) | [Flight Seatmap](http://localhost/echarts-website/examples/en/editor.html?c=geo-seatmap-flight) | [SVG Map](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-map) | [SVG Scatter](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-scatter-simple) | [SVG Lines](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-lines) | [SVG Traffic](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-traffic)
...
See [roam](option.html#geo.roam). Also see example [SVG Map](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-map).
...
Moreover, named elements can also be styled by [visualMap component](option.html#visualMap) if using [series-map](option.html#series-map). See [Beef Cuts](http://localhost/echarts-website/examples/en/editor.html?c=geo-beef-cuts).
...
See [Flight Seatmap](http://localhost/echarts-website/examples/en/editor.html?c=geo-seatmap-flight) for more details.
...
See [Organ Visualization](http://localhost/echarts-website/examples/en/editor.html?c=geo-organ) for more details.
...
See [SVG Map](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-map) for more details.
...
Also see [Organ Visualization](http://localhost/echarts-website/examples/en/editor.html?c=geo-organ) for the usage of label.
...
See also [SVG Scatter](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-scatter-simple), [SVG Lines](http://localhost/echarts-website/examples/en/editor.html?c=geo-svg-lines), [SVG Traffic](http://localhost/echarts-website/examples/en/editor.html?c=geo-traffic).
