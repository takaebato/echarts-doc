...
See also [series-custom.coordinateSystemUsage](#series-custom.coordinateSystemUsage).
...
*   `'box'`: **(Not applicable in [series-custom](#series-custom))**
    ...
    *   For example, a [grid component](#grid) can be laid out in a [matrix coordinate system](#matrix) or a [calendar coordinate system](#calendar), where its layout rectangle is calculated by the specified [series-custom.coords](#series-custom.coords) in that system. See example [sparkline in matrix](http://localhost/echarts-website/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
**See example**: [geo-choropleth-scatter](http://localhost/echarts-website/examples/en/editor.html?c=geo-choropleth-scatter&reset=1&edit=1)
...
See [matrix api.layout example](http://localhost/echarts-website/examples/en/editor.html?c=matrix-mini-bar-data-collection).
...
See a [sample](http://localhost/echarts-website/examples/en/editor.html?c=custom-bar-trend).
...
[image](#series-custom.renderItem.return_image), [text](#series-custom.renderItem.return_text), [circle](#series-custom.renderItem.return_circle), [sector](#series-custom.renderItem.return_sector), [ring](#series-custom.renderItem.return_ring), [polygon](#series-custom.renderItem.return_polygon), [polyline](#series-custom.renderItem.return_polyline), [rect](#series-custom.renderItem.return_rect), [line](#series-custom.renderItem.return_line), [bezierCurve](#series-custom.renderItem.return_bezierCurve), [arc](#series-custom.renderItem.return_arc), [compoundPath](#series-custom.renderItem.return_compoundPath), [group](#series-custom.renderItem.return_group),
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_group.shape), ['`style'`](#series-custom.renderItem.return_group.style), [`'extra'`](#series-custom.renderItem.return_group.extra). For example:
...
See this [example](http://localhost/echarts-website/examples/en/editor.html?c=doc-example/custom-transition-simple&edit=1&reset=1) please.
...
Easing effect. Refer to the following for different effects: [examples](http://localhost/echarts-website/examples/en/editor.html?c=line-easing)
...
See [diffChildrenByName](#series-custom.renderItem.return_group.diffChildrenByName).
...
See this example [example](http://localhost/echarts-website/examples/en/editor.html?c=custom-spiral-race&edit=1&reset=1).
...
In [custom series](#series-custom), when `diffChildrenByName` is set as `true`, for each [group](#series-custom.renderItem.return_group) returned from [renderItem](#series-custom.renderItem), "diff" will be performed to its [children](#series-custom.renderItem.return_group.children) according to the [name](#series-custom.renderItem.return_polygon.name) attribute of each graphic elements. Here "diff" means that map the coming graphic elements to the existing graphic elements when repainting according to `name`, which enables the transition animation if data is modified.
...
See examples: [icons](http://localhost/echarts-website/examples/en/editor.html?c=custom-calendar-icon) and [shapes](http://localhost/echarts-website/examples/en/editor.html?c=custom-gantt-flight).

About width/height, cover/contain, see [layout](#series-custom.renderItem.return_path.shape.layout).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_path.shape), ['`style'`](#series-custom.renderItem.return_path.style), [`'extra'`](#series-custom.renderItem.return_path.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_path.diffChildrenByName).
...
If [width](#series-custom.renderItem.return_path.shape.width), [height](#series-custom.renderItem.return_path.shape.height), [x](#series-custom.renderItem.return_path.shape.x) and [y](#series-custom.renderItem.return_path.shape.y) specified, `pathData` will be transformed to fit the defined rect. If they are not specified, do not do that.

[layout](#series-custom.renderItem.return_path.shape.layout) can be used to specify the transform strategy.
...
Alias of [pathData](#series-custom.renderItem.return_path.shape.pathData).

##### renderItem.return_path.shape.layout
- **Type**: `string`
- **Default**: `'center'`

If [width](#series-custom.renderItem.return_path.shape.width), [height](#series-custom.renderItem.return_path.shape.height), [x](#series-custom.renderItem.return_path.shape.x) and [y](#series-custom.renderItem.return_path.shape.y) specified, `pathData` will be transformed to fit the defined rect.
...
Same to [style](#series-custom.renderItem.return_polygon.style).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_image.shape), ['`style'`](#series-custom.renderItem.return_image.style), [`'extra'`](#series-custom.renderItem.return_image.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_image.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_text.shape), ['`style'`](#series-custom.renderItem.return_text.style), [`'extra'`](#series-custom.renderItem.return_text.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_text.diffChildrenByName).
...
`'left'` means the left side of the text block is specified by the [style.x](#series-custom.renderItem.return_text.style.x), while `'right'` means the right side of the text block is specified by [style.y](#series-custom.renderItem.return_text.style.y).

##### renderItem.return_text.style.width
- **Type**: `number`

Text block width. Used for [overflow](#series-custom.renderItem.return_text.style.overflow) calculation.

##### renderItem.return_text.style.overflow
- **Type**: `string`

When the text content exceeds the [width](#series-custom.renderItem.return_text.style.width), the text display strategy is: `'break'`, `'breakAll'`, `'truncate'`, `'none'`.
...
*   `'truncate'`: truncate the text to display '...'，you can use [ellipsis](#series-custom.renderItem.return_text.style.ellipsis) to customize the display of the ellipsis
*   `'none'`: no line break

##### renderItem.return_text.style.ellipsis
- **Type**: `string`

When [overflow](#series-custom.renderItem.return_text.style.overflow) is set to `'truncate'`, the default is `...`.
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_rect.shape), ['`style'`](#series-custom.renderItem.return_rect.style), [`'extra'`](#series-custom.renderItem.return_rect.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_rect.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_circle.shape), ['`style'`](#series-custom.renderItem.return_circle.style), [`'extra'`](#series-custom.renderItem.return_circle.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_circle.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_ring.shape), ['`style'`](#series-custom.renderItem.return_ring.style), [`'extra'`](#series-custom.renderItem.return_ring.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_ring.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_sector.shape), ['`style'`](#series-custom.renderItem.return_sector.style), [`'extra'`](#series-custom.renderItem.return_sector.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_sector.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_arc.shape), ['`style'`](#series-custom.renderItem.return_arc.style), [`'extra'`](#series-custom.renderItem.return_arc.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_arc.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_polygon.shape), ['`style'`](#series-custom.renderItem.return_polygon.style), [`'extra'`](#series-custom.renderItem.return_polygon.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_polygon.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_polyline.shape), ['`style'`](#series-custom.renderItem.return_polyline.style), [`'extra'`](#series-custom.renderItem.return_polyline.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_polyline.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_line.shape), ['`style'`](#series-custom.renderItem.return_line.style), [`'extra'`](#series-custom.renderItem.return_line.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_line.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_bezierCurve.shape), ['`style'`](#series-custom.renderItem.return_bezierCurve.style), [`'extra'`](#series-custom.renderItem.return_bezierCurve.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_bezierCurve.diffChildrenByName).
...
Shortcut to transition all of the properties in [`'shape'`](#series-custom.renderItem.return_compoundPath.shape), ['`style'`](#series-custom.renderItem.return_compoundPath.style), [`'extra'`](#series-custom.renderItem.return_compoundPath.extra). For example:
...
See [diffChildrenByName](#series-custom.renderItem.return_compoundPath.diffChildrenByName).
...
color. Color is taken from [option.color Palette](#color) by default.
...
This is an [example](http://localhost/echarts-website/examples/en/view.html?c=dataset-encode1&edit=1&reset=1) for `encode`.
...
Check this [example](http://localhost/echarts-website/examples/en/editor.html?c=dataset-series-layout-by).
...
*   When a dimension corresponds to a category axis (axis.type is `'category'`):
    ...
    There is an example of double category axes: [Github Punchcard](http://localhost/echarts-website/examples/en/editor.html?c=scatter-punchCard).
...
> **Notice：**series.data.tooltip only works when [tooltip.trigger](#tooltip.trigger) is `'item'`.  
...
\[WARNING\]: `tooltip` is implemented in HTML (unless [tooltip.renderMode](#tooltip.renderMode) is set as `richText`), allowing users to customize the HTML in this way. The content in the HTML must be properly escaped before being passed in. **Security risks** must be considered when using it. See document ["Security Guidelines"](http://localhost/echarts-website/handbook/en/best-practices/security) for recommendations on safe usage.
...
Easing method used for the first animation. Varied easing effects can be found at [easing effect example](http://localhost/echarts-website/examples/en/editor.html?c=line-easing).
...
See [this example](http://localhost/echarts-website/examples/en/editor.html?c=bar-animation-delay) for more information.
...
> **Notice：**series.tooltip only works when [tooltip.trigger](#tooltip.trigger) is `'item'`.  
