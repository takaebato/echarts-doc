...
See [vertically scrollable legend](http://localhost/echarts-website/examples/en/editor.html?c=pie-legend&edit=1&reset=1) or [horizontally scrollable legend](http://localhost/echarts-website/examples/en/editor.html?c=radar2&edit=1&reset=1).
...
See also [legend.coordinateSystemUsage](#legend.coordinateSystemUsage).
...
See also [legend.coordinateSystem](#legend.coordinateSystem).
