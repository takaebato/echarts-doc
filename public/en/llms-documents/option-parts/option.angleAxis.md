...
The `boundaryGap` of category axis can be set to either `true` or `false`. Default value is set to be `true`, in which case [axisTick](#angleAxis.axisTick) is served only as a separation line, and labels and data appear only in the center part of two [axis ticks](#angleAxis.axisTick), which is called _band_.
...
Interval of axisTick, which is available in category axis. is set to be the same as [axisLabel.interval](#angleAxis.axisLabel.interval) by default.
...
Color of axis label is set to be [axisLine.lineStyle.color](#angleAxis.axisLine.lineStyle.color) by default.
...
Style configuration of minor ticks lines [axisLine.lineStyle.color](#angleAxis.axisLine.lineStyle.color)。
...
**For a time axis ([`angleAxis.type: 'time'`](#angleAxis.type))**
...
Color of axis label is set to be [axisLine.lineStyle.color](#angleAxis.axisLine.lineStyle.color) by default. Callback function is supported, in the following format:
...
Interval of Axis splitLine, which is available in category axis. is set to be the same as [axisLabel.interval](#angleAxis.axisLabel.interval) by default.
...
Interval of Axis splitArea, which is available in category axis. is set to be the same as [axisLabel.interval](#angleAxis.axisLabel.interval) by default.
