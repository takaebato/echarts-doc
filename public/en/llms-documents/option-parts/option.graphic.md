...
[image](#graphic.elements-image), [text](#graphic.elements-text), [circle](#graphic.elements-circle), [sector](#graphic.elements-sector), [ring](#graphic.elements-ring), [polygon](#graphic.elements-polygon), [polyline](#graphic.elements-polyline), [rect](#graphic.elements-rect), [line](#graphic.elements-line), [bezierCurve](#graphic.elements-bezierCurve), [arc](#graphic.elements-arc), [compoundPath](#graphic.elements-compoundPath), [group](#graphic.elements-group),
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-group.shape), ['`style'`](#graphic.elements-group.style), [`'extra'`](#graphic.elements-group.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-image.shape), ['`style'`](#graphic.elements-image.style), [`'extra'`](#graphic.elements-image.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-text.shape), ['`style'`](#graphic.elements-text.style), [`'extra'`](#graphic.elements-text.extra). For example:
...
Text block width. Used for [overflow](#graphic.elements-text.style.overflow) calculation.

#### elements-text.style.overflow
- **Type**: `string`

When the text content exceeds the [width](#graphic.elements-text.style.width), the text display strategy is: `'break'`, `'breakAll'`, `'truncate'`, `'none'`.
...
*   `'truncate'`: truncate the text to display '...'，you can use [ellipsis](#graphic.elements-text.style.ellipsis) to customize the display of the ellipsis
*   `'none'`: no line break

#### elements-text.style.ellipsis
- **Type**: `string`

When [overflow](#graphic.elements-text.style.overflow) is set to `'truncate'`, the default is `...`.
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-rect.shape), ['`style'`](#graphic.elements-rect.style), [`'extra'`](#graphic.elements-rect.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-circle.shape), ['`style'`](#graphic.elements-circle.style), [`'extra'`](#graphic.elements-circle.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-ring.shape), ['`style'`](#graphic.elements-ring.style), [`'extra'`](#graphic.elements-ring.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-sector.shape), ['`style'`](#graphic.elements-sector.style), [`'extra'`](#graphic.elements-sector.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-arc.shape), ['`style'`](#graphic.elements-arc.style), [`'extra'`](#graphic.elements-arc.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-polygon.shape), ['`style'`](#graphic.elements-polygon.style), [`'extra'`](#graphic.elements-polygon.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-polyline.shape), ['`style'`](#graphic.elements-polyline.style), [`'extra'`](#graphic.elements-polyline.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-line.shape), ['`style'`](#graphic.elements-line.style), [`'extra'`](#graphic.elements-line.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-bezierCurve.shape), ['`style'`](#graphic.elements-bezierCurve.style), [`'extra'`](#graphic.elements-bezierCurve.extra). For example:
...
Shortcut to transition all of the properties in [`'shape'`](#graphic.elements-compoundPath.shape), ['`style'`](#graphic.elements-compoundPath.style), [`'extra'`](#graphic.elements-compoundPath.extra). For example:
...
Only one between [left](#graphic.elements-compoundPath.left) and [right](#graphic.elements-compoundPath.right) can work.

If [left](#graphic.elements-compoundPath.left) or [right](#graphic.elements-compoundPath.right) is specified, positioning attributes in [shape](#graphic.elements-compoundPath.shape) (like `x`, `cx`) will not work.
...
Only one between [top](#graphic.elements-compoundPath.top) and [bottom](#graphic.elements-compoundPath.bottom) can work.

If [top](#graphic.elements-compoundPath.top) or [bottom](#graphic.elements-compoundPath.bottom) is specified, positioning attributes in [shape](#graphic.elements-compoundPath.shape) (like `y`, `cy`) will not work.
