...
See [sampleA](http://localhost/echarts-website/examples/en/view.html?c=candlestick-brush&edit=1&reset=1) and [sampleB](http://localhost/echarts-website/examples/en/view.html?c=scatter-nutrients-matrix&edit=1&reset=1).
