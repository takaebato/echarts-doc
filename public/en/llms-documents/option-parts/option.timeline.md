...
See this [example](http://localhost/echarts-website/examples/en/editor.html?c=doc-example/timeline-dynamic-series&edit=1&reset=1).
...
See also [timeline.coordinateSystemUsage](#timeline.coordinateSystemUsage).
...
See also [timeline.coordinateSystem](#timeline.coordinateSystem).
...
*   `'left'`: Put it along the left margin. It is valid when [timline.orient](#timeline.orient) is set as `'horizontal'` .
    
*   `'right'`: Put it along the right margin. It is valid when [timline.orient](#timeline.orient) is set as `'horizontal'`.
    
*   `'top'`: Put it along the margin of the top. It is valid when [timline.orient](#timeline.orient) is set as `'vertical'`.
    
*   `'bottom'`: Put it along the margin of the bottom. It is valid when [timline.orient](#timeline.orient) is set as `'vertical'`.
...
**For a time axis ([`.axisType: 'time'`](#.axisType))**
...
The easing effect of animation of `checkpoint` in `timeline` component. Refers to [easing sample](http://localhost/echarts-website/examples/en/view.html?c=line-easing) for different easing effects.
