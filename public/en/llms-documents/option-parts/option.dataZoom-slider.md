...
Style of handle. Please refer to [area-simple example](http://localhost/echarts-website/examples/en/editor.html?c=area-simple).
...
See also [dataZoom-slider.coordinateSystemUsage](#dataZoom-slider.coordinateSystemUsage).
...
*   `'box'`:
    ...
    *   For example, a [grid component](#grid) can be laid out in a [matrix coordinate system](#matrix) or a [calendar coordinate system](#calendar), where its layout rectangle is calculated by the specified [dataZoom-slider.coords](#dataZoom-slider.coords) in that system. See example [sparkline in matrix](http://localhost/echarts-website/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [dataZoom-slider.coordinateSystem](#dataZoom-slider.coordinateSystem).
