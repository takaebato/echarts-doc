...
See also [series-funnel.coordinateSystemUsage](#series-funnel.coordinateSystemUsage).
...
*   `'box'`: **(Not applicable in [series-funnel](#series-funnel))**
    ...
    *   For example, a [grid component](#grid) can be laid out in a [matrix coordinate system](#matrix) or a [calendar coordinate system](#calendar), where its layout rectangle is calculated by the specified [series-funnel.coords](#series-funnel.coords) in that system. See example [sparkline in matrix](http://localhost/echarts-website/examples/en/editor.html?c=matrix-sparkline&edit=1&reset=1).
...
See also [series-funnel.coordinateSystem](#series-funnel.coordinateSystem).
...
The first parameter `value` is the value in [data](#series-funnel.data), and the second parameter `params` is the rest parameters of data item.
...
1.  Assign coordinate according to container with [x](#series-funnel.markPoint.data.x), [y](#series-funnel.markPoint.data.y) attribute, in which pixel values and percentage are supported.
...
Mark point name. Can be used as a template variable **data name** `{b}` in [label formatter](#series-funnel.markPoint.data.label.formatter).
...
Options: `'container'` or `'coordinate'`. Specify whether the positions of [x](#series-funnel.markPoint.data.x) and [y](#series-funnel.markPoint.data.y) are relative to the entire chart container (`'container'`, default) or the grid coordinate system (`'coordinate'`).
...
Symbol type at the two ends of the mark line. It can be an array for two ends, or assigned separately. See [data.symbol](#series-funnel.markLine.data.0.symbol) for more format information.
...
1.  Assign coordinate according to container with [x](#series-funnel.markLine.data.0.x), [y](#series-funnel.markLine.data.0.y) attribute, in which pixel values and percentage are supported.
...
Name of the marker. Can be used as a template variable **data name** `{b}` in [label formatter](#series-funnel.markLine.data.label.formatter).
...
1.  Specify the coordinate in screen coordinate system using [x](#series-funnel.markArea.data.0.x), [y](#series-funnel.markArea.data.0.y), where the unit is pixel (e.g., the value is `5`), or percent (e.g., the value is `'35%'`).
...
Name of the marker, which will display as a label. Can be used as a template variable **data name** `{b}` in [label formatter](#series-funnel.markArea.data.label.formatter).
