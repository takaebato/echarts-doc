...
If there have to be too many legend items, [vertically scrollable legend](http://localhost/echarts-website/examples/en/editor.html?c=pie-legend&edit=1&reset=1) or [horizontally scrollable legend](http://localhost/echarts-website/examples/en/editor.html?c=radar2&edit=1&reset=1) are options to paginate them. Check [legend.type](#legend.type) please.
...
See the [example](http://localhost/echarts-website/examples/en/editor.html?c=line-tooltip-touch&edit=1&reset=1).
...
In this [example](http://localhost/echarts-website/examples/en/view.html?c=scatter-map-brush&edit=1&reset=1), `debounce` is used to make sure the bar chart is updated only when the user has stopped action. In other cases, the animation result may not be so good.
...
**Tip:** The region color can also be controlled by map series. See [series-map.geoIndex](#series-map.geoIndex).
...
[Display Text in Calendar](http://localhost/echarts-website/examples/en/editor.html?c=calendar-lunar&edit=1&reset=1), [Display Pies in Calendar](http://localhost/echarts-website/examples/en/editor.html?c=calendar-pie&edit=1&reset=1)
...
And other **mini charts** examples: [matrix mini bar example](http://localhost/echarts-website/examples/en/editor.html?c=matrix-mini-bar-data-collection&edit=1&reset=1).
...
Examples: [graph NPM](http://localhost/echarts-website/examples/en/editor.html?c=graph-npm&edit=1&reset=1), [graph Webkit dep](http://localhost/echarts-website/examples/en/editor.html?c=graph-webkit-dep&edit=1&reset=1).
...
More details about `dataset` can be checked in the [tutorial](http://localhost/echarts-website/handbook/en/concepts/dataset/).
...
Multiple `series` can be displayed in the same coordinate system. Please refer to [this example](http://localhost/echarts-website/examples/en/editor.html?c=boxplot-multi&edit=1&reset=1).
...
`encode.tooltip` and `encode.label` can also be specified to define the content of default `tooltip` and `label`. [series.dimensions](#series-custom.dimensions) can also be specified to defined names of each dimensions, which will be displayed in tooltip.
