...
**ACTION:** [legendToggleSelect](#action.legend.legendToggleSelect) Event emitted after legend selecting state changes.
...
**ACTION:** [legendSelect](#action.legend.legendSelect) Event emitted after legend is selected.
...
**ACTION:** [legendUnSelect](#action.legend.legendUnSelect) Event emitted after unselecting legend.
...
**ACTION:** [legendAllSelect](#action.legend.legendAllSelect) Event emitted after all legends are selected.
...
**ACTION:** [legendInverseSelect](#action.legend.legendInverseSelect) Event emitted after inversing all legends.
...
**ACTION:** [legendscroll](#action.legend.legendScroll) Event when trigger legend scroll.
...
**ACTION:** [selectDataRange](#action.dataRange.selectDataRange) Event emitted after range is changed in visualMap.
...
**ACTION:** [timelineChange](#action.timeline.timelineChange) Event emitted after time point in timeline is changed.
...
**ACTION:** [timelinePlayChange](#action.timeline.timelinePlayChange) Switching event of play state in timeline.
...
**ACTION:** [restore](#action.toolbox.restore) Resets option event.
...
**ACTION:** [geoToggleSelect](#action.geo.geoToggleSelect)
...
**ACTION:** [geoSelect](#action.geo.geoSelect)

Event after selecting.

Use `dispatchAction` can trigger this event, but user clicking this event won't trigger this (User clicking event please use [geoselectchanged](#events.geoselectchanged)).
...
**Attention:** Event triggered by user switching legend in ECharts 2.x is changed from `geoselected` to [geoselectchanged](#events.geoselectchanged).

## geounselected
- **Type**: `Event`

**ACTION:** [geoUnSelect](#action.geo.geoUnSelect)

cancels selected event.

Use `dispatchAction` will trigger this event, but user clicking won't trigger it. (For user clicking event, please refer to [geoselectchanged](#events.geoselectchanged)).
...
**Tip:** [brush.throttleType](option.html#brush.throttleType) can be used to avoid triggering this event too frequently.
