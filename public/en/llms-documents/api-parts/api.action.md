...
**EVENT:** [geoselected](#events.geoselected)
...
**EVENT:** [geounselected](#events.geounselected)
...
**EVENT:** [geoselectchanged](#events.geoselectchanged)
...
This action is dispatched when the "brush" behavior finished. The parameters are the same as [action brush](#action.brush.brush).

### brush.takeGlobalCursor
- **Type**: `*`

The switch of the brush. This action can make the mouse enabled/disabled to brush. In fact, the brush buttons in [toolbox](option.html#toolbox.feature.brush) just use this action.
