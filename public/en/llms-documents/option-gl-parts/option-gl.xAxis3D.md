...
*   `'category'` The category axis. Suitable for the discrete category data. For this type, the category data must be set through [data](#xAxis3D.data).
...
This is unavailable for 'category' and 'time' axes. Logged value should be passed for [type](#xAxis3D.type): 'log' axis.
